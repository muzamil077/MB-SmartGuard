<script lang="ts">
	...
	function openAllStates() {
		showConfirmationModal(
			'Do You Want to Open All System Apps?',
			'This action will open all system apps on this device. Are you sure you want to proceed?',
			'Yes, Open All',
	...
	function closeAllStates() {
		showConfirmationModal(
			'Do You Want to Close All System Apps?',
			'This action will close all system apps on this device. Are you sure you want to proceed?',
			'Yes, Close All',
		...
		{#if showContent}
			...
			{:else if filteredCategoryTable.length === 0}
				<div class="flex items-center justify-center pt-4">
					<p class="text-sm font-medium text-neutral-600">No system apps found</p>
				</div>
			{:else}
				<div class="flow-root">
